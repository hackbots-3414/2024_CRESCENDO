...
public class TunerConstants {
	...
	private static final Slot0Configs driveGains = new Slot0Configs()
		.withKP(0.0075).withKI(0).withKD(0) 
		.withKS(0).withKV(0).withKA(0);
	...
	private static final double kCoupleRatio = 3.5; // ************FLAG***************

	private static final double kDriveGearRatio = 8.14;
	private static final double kSteerGearRatio = 21.4285714286;
	private static final double kWheelRadiusInches = 2; // Estimated at first, then fudge-factored to make odom match record
	...
	private static final double kFrontLeftEncoderOffset = 0.7217; // 360 degrees = 1
	...
	private static final double kFrontRightEncoderOffset = 0.2000;
	...
	private static final double kBackLeftEncoderOffset = 0.8748;
	...
	private static final double kBackRightEncoderOffset = 0.2614;
