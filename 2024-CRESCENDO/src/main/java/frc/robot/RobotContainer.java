...
public class RobotContainer {
  ...
  private void configureXboxOperatorBindings() {
    ...
    xboxOperator.leftBumper().whileTrue(subsystemManager.makeFeederCommand(driverLeftY, driverLeftX, driverRightX)); // left bumper
  ...
  private void configurePS5OperatorBindings() {
    ...
    ps5Operator.L1().whileTrue(subsystemManager.makeFeederCommand(driverLeftY, driverLeftX, driverRightX)); // left bumper
  }
